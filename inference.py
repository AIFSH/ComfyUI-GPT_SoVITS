...
is_half = True and cuda_malloc.cuda_malloc_supported()

cnhubert_base_path = os.path.join(parent_directory,'pretrained_models/chinese-hubert-base')
...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, 
    ...
    wavwrite(outfile,hps.data.sampling_rate,
